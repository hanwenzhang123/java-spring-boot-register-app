...
public class WebController {
    ...
    @PostMapping("/course")
    public ResponseEntity<Course> createGroup(@RequestBody Course course) throws URISyntaxException {
    ...
    public ResponseEntity<Course> updateGroup(@RequestBody Course course) {
